	...
	public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception
	{
		httpSecurity
			...
			.authorizeHttpRequests(authz -> authz
					.requestMatchers("/authenticate/add", "/authenticate/login","/authenticate/changepassword","/authenticate/forget/{username}","/authenticate/del","/authenticate/remove/{username}")
					.permitAll()
